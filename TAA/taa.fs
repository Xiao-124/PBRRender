...
void main()
{
	...
	//vec2 prevDepthUV =  PrevCoord + Jitter - LastJitter;
	//float lastFrameDepth = texture( prevDepth,   prevDepthUV);
	//float lastFrameMV = texture( prevVelocity,   prevDepthUV);
	//float lastFrameLen = dot(lastFrameMV, lastFrameMV);
	//
	//for(int i = 0; i < 8; i++)
	//{
	//
