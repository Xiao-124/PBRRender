...
public:
    ...
    constexpr Gamut(glm::vec2 r, glm::vec2 g, glm::vec2 b) : Gamut(Primaries{ r, g, b }) 
    {
    }
...
//! Standard CIE 1931 2бу illuminant D65. This illuminant has a color temperature of 6504K.
