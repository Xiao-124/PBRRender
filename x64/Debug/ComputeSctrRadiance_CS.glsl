...
uniform sampler3D g_tex3DPreviousSctrOrder;
SamplerState g_tex3DPreviousSctrOrder_sampler;
uniform sampler2D g_tex2DSphereRandomSampling;
layout(rgba32f, binding=0)uniform IMAGE_WRITEONLY image3D g_rwtex3DSctrRadiance;
...
void main()
{
    ...
    imageStore( g_rwtex3DSctrRadiance, _ToIvec(ThreadId), _ExpandVector( float4(f3SctrRadiance, 0.0)));
}